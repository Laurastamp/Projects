    ...
    initialize: function() {
        ...
        this.__stripParams = function(fullPath) {
            ...
            this.TrackUpdatesAjaxScript = function(settings, event, xhr) {
                ...
                var atr = {
                    'category': 'USPS Tracking Available Actions',
                    'action': 'Text & Email Updates'
                };
                var opts = [];
            ...
            this.clickLandMap = {
                ...
                "TrackConfirmAction": {
                    ...
                    "div.diPanel button.white btn-zip-code-search": {
                        "event": "availableActions",
                        "attribute": {
                            "category": "USPS Tracking Available Actions",
                    ...
                    "div.diPanel button.change-options-btn": {
                        "event": "availableActions",
                        "attribute": {
                            "category": "USPS Tracking Available Actions",
                    ...
                    "div.diPanel button.add-to-cart": {
                        "event": "availableActions",
                        "attribute": {
                            "category": "USPS Tracking Available Actions",
                    ...
                    "div.diPanel button.calculatePrice": {
                        "event": "availableActions",
                        "attribute": {
                            "category": "USPS Tracking Available Actions",
                    ...
                    "div.diPanel button.continue-delivery": {
                        "event": "availableActions",
                        "attribute": {
                            "category": "USPS Tracking Available Actions",
                            "action": "DI Continue"
